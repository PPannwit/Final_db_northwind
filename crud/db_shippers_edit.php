...
$products = getEdit($pdo, 'tb_shippers', 'i_ShipperID', $_POST['pid']);
// print_r($products);
...
<head>
    ...
    <script>
        function EditData(pid) {
            console.log("Edit Shipper ID : " + pid);
    ...
    <div class="container d-flex align-items-center justify-content-center" style="min-height: 90vh;">
        <div class="card w-75">
            ...
            <div class="card-header">
                <!-- From Input -->
                <div class="card-body">
                    <h2 class="text-center">แก้ไขข้อมูลผู้จัดส่ง</h2>
                    <form action="../include/action_update.php" method="post">
                        <input type="hidden" name="tb_name" value="tb_shippers">
                        <input type="hidden" name="action" value="update">
                        <?= input_text("i_ShipperID", "รหัสผู้จัดส่ง", "number", $products["i_ShipperID"], "กรุณากรอกรหัสผู้จัดส่ง", true); ?>
                        <?= input_text("c_ShipperName", "ชื่อผู้จัดส่ง", "text", $products["c_ShipperName"], "กรุณากรอกชื่อผู้จัดส่ง"); ?>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content shadow-lg border-0">
                                        ...
                                        <div class="modal-body">
                                            <p class="mb-2">คุณต้องการบันทึกการเปลี่ยนแปลงข้อมูลผู้จัดส่งใช่หรือไม่?</p>
