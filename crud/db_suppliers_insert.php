...
$NewID = getNewID($pdo, "tb_suppliers", "i_SupplierID");
    ...
    <div class="container d-flex align-items-center justify-content-center" style="min-height: 90vh;">
        <div class="card w-75">
            ...
            <div class="card-header">
                <!-- From Input -->
                <div class="card-body">
                    <h2 class="text-center">เพิ่มข้อมูลผู้จัดจำหน่าย</h2>
                    <form action="../include/action.php" method="post">
                        <input type="hidden" name="tb_name" value="tb_suppliers">
                        <input type="hidden" name="action" value="insert">
                        <?= input_text("c_SupplierName", "ชื่อผู้จัดจำหน่าย", "text", null, "กรุณากรอกชื่อผู้จัดจำหน่าย"); ?>
                        <?= input_text("c_ContactName", "ชื่อผู้ติดต่อ", "text", null, "กรุณากรอกชื่อผู้ติดต่อ"); ?>
                        <?= input_text("c_Phone", "เบอร์โทรศัพท์", "text", null, "กรุณากรอกเบอร์โทรศัพท์"); ?>
                        ...
                        <div class="text-center mt-4"><button type="submit" class="btn btn-success">เพิ่มผู้จัดจำหน่าย</button></div>
                    </form>
                    <!-- Button Action -->
                </div>
</body>
