...
elseif ($current_page > $total_pages && $total_pages > 0) $current_page = $total_pages;
        ...
        <div class="card-body table-responsive">
            <table class="table table-bordered table-sm">
                ...
                <tr>
                    ...
                    <td>
                        <form action="./db_orderdetails.php" method="POST">
            ...
            <div class="card-footer">
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination justify-content-end">
                        ...
                        $show_pages = [];
                        $show_pages[] = 1;
                        if ($total_pages >= 2) $show_pages[] = 2;
                        if ($current_page > 4) $show_pages[] = '...';
                        for ($i = $current_page - $adjacents; $i <= $current_page + $adjacents; $i++) {
                            if ($i > 2 && $i < $total_pages - 1) $show_pages[] = $i;
                        }
                        if ($current_page < $total_pages - 3) $show_pages[] = '...';
                        if ($total_pages > 2) $show_pages[] = $total_pages - 1;
